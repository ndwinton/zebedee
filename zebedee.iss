...
AppVerName=Zebedee Secure Tunnel Version 2.2.1
...
Name: "{group}\Documentation (English)"; Filename: "{app}\zebedee.html"
Name: "{group}\Documentation (Japanese)"; Filename: "{app}\zebedee.ja_JP.html"
